...
import 'package:hi_netx/src/error.dart';
import 'package:hi_netx/src/request.dart';
import 'package:hi_netx/src/response.dart';
...
class HiDioAdapter extends HiBaseAdapter {
  ...
  Future<HiBaseResponse> buildResponse(
    ...
    if (response?.statusCode != 200) {
      base = HiBaseResponse(code: response?.statusCode ?? -1, message: response?.statusMessage ?? '');
    }
