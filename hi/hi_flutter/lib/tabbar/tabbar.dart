...
class HiTabBar extends StatefulWidget implements PreferredSizeWidget {
  const HiTabBar({
    super.key,
    required this.tabs,
    this.controller,
  ...
  _HiTabBarState createState() => _HiTabBarState();
}

class _HiTabBarState extends State<HiTabBar> {
  ...
  @override
  void didUpdateWidget(HiTabBar oldWidget) {
